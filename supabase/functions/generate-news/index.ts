...
2. Перший абзац: головна новина дня — який K-індекс, який рівень (зелений/жовтий/помаранчевий/червоний), чи очікується магнітна буря. Посилайся на "дані Центру прогнозування космічної погоди NOAA". 2-3 речення.
...
4. Третій абзац: прогноз на найближчі 1-2 дні з конкретними значеннями K-індексу з даних прогнозу. 2-3 речення.
...
- Посилайся на джерело як "Центр прогнозування космічної погоди NOAA" або "за даними NOAA"`;
