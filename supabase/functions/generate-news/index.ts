...
Вимоги:
- Заголовок як у новинах, наприклад: "Магнітна буря 15 лютого: чого очікувати українцям"
- СТРОГО 500-700 символів тексту, 4 коротких абзаци
- Кожен абзац — 2-3 речення, не більше
- Абзац 1: загальна ситуація (рівень, чи є загроза)
- Абзац 2: причина активності (сонце, корональні викиди)
- Абзац 3: що означає цей рівень для техніки
- Абзац 4: вплив на здоров'я, коротка порада
- Без емодзі, без markdown, без списків
- Стримано, по-журналістськи, короткі речення
