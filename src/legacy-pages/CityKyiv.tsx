            ...
            {data?.current && (
              <div className="space-y-1.5">
                ...
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="font-mono font-medium text-foreground">{new Date(data.current.sunrise).toLocaleTimeString(localeTag, { hour: "2-digit", minute: "2-digit", timeZone: "Europe/Kyiv" })}</span>
                </div>
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="font-mono font-medium text-foreground">{new Date(data.current.sunset).toLocaleTimeString(localeTag, { hour: "2-digit", minute: "2-digit", timeZone: "Europe/Kyiv" })}</span>
                </div>
