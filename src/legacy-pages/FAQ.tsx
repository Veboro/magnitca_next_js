...
const localizedCopy: Record<LegacyLocale, (typeof copy)["uk"]> = {
  ...
  bg: {
    metaTitle: "Често задавани въпроси — Magnitca България | Въпроси за магнитните бури",
    metaDescription:
      "Отговори на често задаваните въпроси, свързани с магнитните бури, Kp-индекса, слънчевия вятър и въздействието върху организма.",
    heading: "Често задавани въпроси",
    intro:
      "Кратки и разбираеми обяснения за магнитните бури, слънчевата активност, Kp-индекса и въздействието на космическото време.",
    sections: [
      {
        title: "Основи на магнитните бури",
        icon: Zap,
        items: [
          {
            q: "Какво представлява магнитната буря?",
            a: "Магнитната буря е временно смущение на магнитното поле на Земята, причинено от заредени частици, идващи от Слънцето.",
          },
          {
            q: "Какво представлява Kp-индексът?",
            a: "Kp-индексът е показател за глобалната геомагнитна активност със стойности от 0 до 9. Стойностите от 0 до 3 се считат за спокойни, а над 5 вече говорим за геомагнитна буря.",
          },
          {
            q: "Какво означава скалата G1-G5?",
            a: "G-скалата на NOAA обозначава силата на геомагнитните бури. G1 означава слаба буря, а G5 — екстремна буря.",
          },
          {
            q: "Колко често се случват магнитни бури?",
            a: "Това зависи от приблизително 11-годишния цикъл на активност на Слънцето. По време на слънчев максимум по-силните геомагнитни смущения са по-чести, а по време на слънчев минимум значителните бури се случват по-рядко.",
          },
          {
            q: "Зависи ли магнитната буря от конкретен град или държава?",
            a: "Kp-индексът е глобален показател, затова самата геомагнитна активност не се променя от град до град. Разликата е по-скоро в това, че географската ширина, времето и местните условия влияят например върху видимостта на полярното сияние.",
          },
        ],
      },
      {
        title: "Слънчева активност",
        icon: Sun,
        items: [
          {
            q: "Какво представлява слънчевият вятър?",
            a: "Слънчевият вятър е непрекъснат поток от заредени частици, идващи от Слънцето. Неговата скорост и плътност влияят върху това какъв натиск изпитва магнитосферата на Земята.",
          },
          {
            q: "Какво представлява компонентата IMF Bz?",
            a: "Bz е вертикалната компонента на междупланетното магнитно поле. Отрицателните, насочени на юг стойности могат да увеличат вероятността за геомагнитно смущение.",
          },
          {
            q: "Защо прогнозата се променя през деня?",
            a: "Космическото време е динамично. Слънчевият вятър, компонентата Bz и прогнозите на NOAA могат да се обновяват въз основа на нови измервания.",
          },
          {
            q: "Какво представлява коронарното изхвърляне на маса?",
            a: "Коронарното изхвърляне на маса, или CME, е голямо количество плазма и магнитно поле, изхвърлени от Слънцето. Ако се насочи към Земята, след 1-3 дни може да предизвика геомагнитна буря.",
          },
          {
            q: "Какво представляват слънчевите изригвания?",
            a: "Слънчевите изригвания са внезапни освобождавания на енергия на повърхността и в атмосферата на Слънцето. Силните изригвания могат да причинят радиосмущения, а ако са съпроводени с изхвърляне на материя, могат да повлияят и на последвалата геомагнитна активност.",
          },
          {
            q: "Какво означават скалите R и S?",
            a: "R-скалата обозначава смущенията от слънчеви изригвания, засягащи радиокомуникациите, а S-скалата — радиационните бури. Те са важни главно за спътниците, радиовръзките, авиацията и космическите апарати.",
          },
        ],
      },
      {
        title: "Въздействие върху самочувствието",
        icon: Heart,
        items: [
          {
            q: "Усещат ли се магнитните бури?",
            a: "Някои метеочувствителни хора могат да изпитват умора, главоболие, раздразнителност или по-неспокоен сън по време на повишена геомагнитна активност.",
          },
          {
            q: "Какво е добре да се прави в активните дни?",
            a: "Добре е да се поддържа по-спокойно темпо, да се пие достатъчно вода, да се избягва претоварване и да се следи прогнозата. Сайтът не замества медицинска консултация.",
          },
          {
            q: "Кои хора могат да бъдат по-чувствителни към геомагнитната активност?",
            a: "По-често се споменават възрастните хора, тези със сърдечно-съдови проблеми, хората с хронични заболявания и онези, които така или иначе са чувствителни към промените на времето. Реакцията обаче е много индивидуална.",
          },
          {
            q: "Считат ли се тези сведения за медицински съвет?",
            a: "Не. Magnitca предоставя информативни данни и общи обяснения. При продължителни оплаквания, силни симптоми или хронично заболяване винаги е добре да се консултирате с лекар.",
          },
        ],
      },
      {
        title: "Въздействие върху технологиите",
        icon: Wifi,
        items: [
          {
            q: "Може ли магнитната буря да повлияе на GPS?",
            a: "По време на по-силни геомагнитни бури смущенията в йоносферата могат да влошат точността на спътниковата навигация. В ежедневната употреба това често не е забележимо, но за професионалните системи може да е важно.",
          },
          {
            q: "Влияе ли магнитната буря на мобилните телефони?",
            a: "Ежедневните телефони обикновено не се повреждат директно. По време на силни бури обаче точността на определени комуникационни или навигационни системи може да се влоши.",
          },
          {
            q: "Защо енергийните системи следят космическото време?",
            a: "Много силните геомагнитни бури могат да индуцират електрически токове в големи проводящи системи, например електропреносните линии. Затова за енергийния сектор следенето на G-скалата е важен инструмент за управление на риска.",
          },
        ],
      },
      {
        title: "Данни и прогноза",
        icon: Activity,
        items: [
          {
            q: "Откъде идват данните?",
            a: "Данните за космическото време идват от отворените източници на NOAA SWPC. Magnitca ги представя в по-разбираема форма.",
          },
          {
            q: "Колко често се обновяват данните?",
            a: "Показателите се обновяват редовно през деня в зависимост от наличността на изходните данни.",
          },
          {
            q: "Безплатна ли е услугата?",
            a: "Да, основната информация е достъпна безплатно, без регистрация.",
          },
          {
            q: "Колко точна е 3-дневната прогноза?",
            a: "По-краткосрочната прогноза обикновено е по-полезна, защото има повече свежи измервания. Въпреки това космическото време може да се променя бързо, затова числата е добре да се възприемат като актуална моментна картина.",
          },
          {
            q: "Защо текущият Kp и дневният максимум може да се различават?",
            a: "Текущият Kp показва актуалното състояние, докато дневният максимум е най-високата очаквана или вече измерена стойност за конкретния ден. Затова е възможно сутринта активността да е била по-висока, а следобед положението вече да е по-спокойно.",
          },
          {
            q: "Може ли Magnitca да се използва за критични решения?",
            a: "За критични технически, авиационни, енергийни или здравни решения винаги трябва да се проверяват първичните официални източници и професионалните протоколи. Целта на Magnitca е разбираемото информиране.",
          },
        ],
      },
    ],
