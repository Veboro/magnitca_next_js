      ...
      <div className="mt-8 space-y-6 rounded-3xl border border-border/50 bg-card p-6 text-sm leading-7 text-foreground/85 shadow-sm">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>аналітичні cookie, якщо на сайті увімкнена статистика відвідувань, зокрема через Google Analytics 4;</li>
        ...
        <section className="space-y-3">
          ...
          <p>
            Якщо на сайті активовано Google Analytics 4, аналітичні cookie можуть використовуватися
            для підрахунку переглядів сторінок, оцінки джерел трафіку, аналізу взаємодії з контентом
            та загального покращення структури й зручності сайту.
          </p>
        </section>
        <section className="space-y-3">
