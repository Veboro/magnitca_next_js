  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-10">
      ...
      <div className="mt-8 space-y-6 rounded-3xl border border-border/50 bg-card p-6 text-sm leading-7 text-foreground/85 shadow-sm">
        ...
        <section className="space-y-3">
          <h2 className="font-display text-xl font-bold text-foreground">Методология и научные ограничения</h2>
          <p>
            Показатели «влияние на самочувствие» и «уровень чувствительности» — это эвристические
            оценки на основе открытых данных (Kp-индекса и геомагнитной активности, а где показано —
            изменений атмосферного давления). Это общий ориентир, а не медицинский диагноз или
            персональный прогноз; каждый человек реагирует по-разному.
          </p>
          <p>
            Связь между геомагнитной активностью и самочувствием человека научно не доказана
            окончательно — имеющиеся исследования ограничены и дают противоречивые результаты.
            Материалы носят информационный характер и не заменяют профессиональную медицинскую
            консультацию. При проблемах со здоровьем обращайтесь к квалифицированному врачу.
          </p>
        </section>
