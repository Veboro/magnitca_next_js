...
const COPY: Record<SiteLocale, PageCopy> = {
  ...
  bg: {
    metaTitle: "Влияние на магнитните бури върху самочувствието — реални истории на хора",
    metaDescription:
      "Как се чувстват хората по време на магнитни бури: реални истории за главоболие, кръвно налягане, умора и настроение. Всяка история е свързана с оценка на самочувствието и Kp-индекса за съответния ден.",
    homeLabel: "Магнитка",
    breadcrumbCurrent: "Самочувствие",
    badge: "Истории за самочувствието",
    h1: "Влияние на магнитните бури върху самочувствието",
    seo: "Тук сме събрали реални истории на хора за това как се чувстват по време на магнитни бури: главоболие, промени в кръвното налягане, умора, тревожност или, напротив, спокойни дни. Всяка история е свързана с оценка на самочувствието и Kp-индекса за съответния ден, така че можете да видите как различни хора преживяват една и съща геомагнитна обстановка. Това е личен опит, а не медицински съвет.",
    anonymous: "Анонимен",
    relatedTitle: "Вижте също",
    relatedKp: "Kp-индекс днес",
    relatedCalendar: "Календар на магнитните бури",
    faqTitle: "Често задавани въпроси",
    faq: [
      {
        q: "Наистина ли магнитните бури влияят върху самочувствието?",
        a: "Част от хората съобщават за главоболие, колебания на кръвното налягане, умора или тревожност в дните на геомагнитни смущения. Научните данни са противоречиви, затова тези истории са личен опит, а не медицински съвет.",
      },
      {
        q: "Кои симптоми се споменават най-често по време на магнитни бури?",
        a: "Най-често — главоболие и усещане за натиск в слепоочията, умора и сънливост, колебания на артериалното налягане, раздразнителност, тревожност и нарушения на съня.",
      },
      {
        q: "Как са свързани Kp-индексът и самочувствието?",
        a: "Kp-индексът показва силата на геомагнитната активност. Всяка история в емисията е свързана с Kp-индекса за съответния ден, така че можете да сравните как се чувстват различни хора при едно и също ниво на буря.",
      },
      {
